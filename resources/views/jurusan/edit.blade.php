            ...
            <div class="col-sm-8 col-md-6">
                ...
                <form action="{{ url('/jurusans/' . $jurusan->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jumlah_mahasiswa" id="jumlah_mahasiswa" class="form-control @error('jumlah_mahasiswa') is-invalid @enderror" value="{{ old('jumlah_mahasiswa', $jurusan->jumlah_mahasiswa) }}">
